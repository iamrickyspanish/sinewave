...
keyboard keyboard_create (const kb_key_t keys[],
...
void item_to_string_fn (const void* kb,
char string[],
...
//     unsigned short string_length =
//     list_get_length(kb->pressed_keys)*ITEM_STRING_SIZE; char*
//     pressed_keys_string = malloc((string_length+1)*sizeof(char)); strcpy(pressed_keys_string,
//     ""); list_to_string(kb->pressed_keys, pressed_keys_string, string_length,
//     &item_to_string_fn, ITEM_STRING_SIZE); puts(pressed_keys_string);
